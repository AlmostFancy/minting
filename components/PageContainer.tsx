...
function PageContainer({
    ...
    return (
        <div className="flex h-screen flex-col">
            <div
                className={`flex min-h-[80px] w-full items-center justify-between border-b border-black bg-white px-[20px] py-[15px] text-center md:px-[40px] md:py-[21px]`}
            >
                <Link href="/">
            ...
            {!overrideFooter && (
                <div
                    className={`relative bottom-0 flex h-[70px] w-full items-center justify-end border-t border-black bg-white py-[20px] px-[20px] text-center md:justify-between md:px-[40px]`}
                >
                    ...
                    <div className="flex flex-row space-x-5">
                        ...
                        <Link href="https://looksrare.org/collections/0x8Dc1c7571aC722871a76a0b4949847bB4bFAD28C">
                            <a target="_blank">
                                <Image
                                    className="hover:opacity-60"
                                    src="/images/lr.svg"
                        ...
                        <Link href="https://opensea.io/collection/almost-fancy-founders-club">
                            <a target="_blank">
                                <Image
                                    className="hover:opacity-60"
                                    src="/images/os.svg"
